...
const Form = () => {
  return (
    <div className="form-parent">
      <div  id="item1">
        <img  className="icon" src={vector17} width={50} height={30} ></img>
        <b className="b15">+2500</b><br></br>
        <b className="des">Houses Available</b>
      </div>
      <div  id="item2">
        <img  className="icon" src={vector18}  width={50} height={30}></img>
        <b className="b15">+500</b><br></br>
        <b className="des"> Cities Covered</b>
      </div>
      <div  id="item3">
        <img  className="icon" src={facesmilesolid}  width={50} height={30}></img>
